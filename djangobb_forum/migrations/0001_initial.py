    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(related_name='ban_users', verbose_name='Banned user', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Ban',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(related_name='forums', verbose_name='Category', to='djangobb_forum.Category', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['position'],
                'verbose_name': 'Forum',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poll', models.ForeignKey(related_name='choices', to='djangobb_forum.Poll', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', djangobb_forum.fields.AutoOneToOneField(to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_count', models.IntegerField(default=0, verbose_name='Post count', blank=True)),
                ('user', djangobb_forum.fields.AutoOneToOneField(related_name='forum_profile', verbose_name='User', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(verbose_name='Post', to='djangobb_forum.Post', on_delete=models.CASCADE)),
                ('reported_by', models.ForeignKey(related_name='reported_by', verbose_name='Reported by', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('zapped_by', models.ForeignKey(related_name='zapped_by', verbose_name='Zapped by', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL)),
            ],
            options={
                'verbose_name': 'Report',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(related_name='reputations_from', verbose_name='From', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('post', models.ForeignKey(related_name='post', verbose_name='Post', to='djangobb_forum.Post', on_delete=models.CASCADE)),
                ('to_user', models.ForeignKey(related_name='reputations_to', verbose_name='To', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_count', models.IntegerField(default=0, verbose_name='Post count', blank=True)),
                ('forum', models.ForeignKey(related_name='topics', verbose_name='Forum', to='djangobb_forum.Forum', on_delete=models.CASCADE)),
                ('last_post', models.ForeignKey(related_name='last_topic_post', blank=True, to='djangobb_forum.Post', null=True, on_delete=models.SET_NULL)),
        ...
        migrations.AddField(
            model_name='post',
            name='topic',
            field=models.ForeignKey(related_name='posts', verbose_name='Topic', to='djangobb_forum.Topic', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='post',
            name='updated_by',
            field=models.ForeignKey(verbose_name='Updated by', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='post',
            name='user',
            field=models.ForeignKey(related_name='posts', verbose_name='User', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='poll',
            name='topic',
            field=models.ForeignKey(to='djangobb_forum.Topic', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='poll',
            name='users',
        ...
        migrations.AddField(
            model_name='forum',
            name='last_post',
            field=models.ForeignKey(related_name='last_forum_post', blank=True, to='djangobb_forum.Post', null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='forum',
            name='moderators',
        ...
        migrations.AddField(
            ...
            name='post',
            field=models.ForeignKey(related_name='attachments', verbose_name='Post', to='djangobb_forum.Post', on_delete=models.CASCADE),
        ),
