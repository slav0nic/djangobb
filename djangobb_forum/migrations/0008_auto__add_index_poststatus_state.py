...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PostStatus', fields ['state']
        db.create_index('djangobb_forum_poststatus', ['state'])


    def backwards(self, orm):
        # Removing index on 'PostStatus', fields ['state']
        db.delete_index('djangobb_forum_poststatus', ['state'])
    ...
    models = {
        ...
        'djangobb_forum.poststatus': {
            ...
            'state': ('django_fsm.db.fields.fsmfield.FSMField', [], {'default': "'unreviewed'", 'max_length': '50', 'db_index': 'True'}),
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['djangobb_forum.Topic']"}),
