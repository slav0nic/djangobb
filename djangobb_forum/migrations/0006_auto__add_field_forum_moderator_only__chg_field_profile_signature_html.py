...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.moderator_only'
        db.add_column('djangobb_forum_forum', 'moderator_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Profile.signature_html'
        db.alter_column('djangobb_forum_profile', 'signature_html', self.gf('django.db.models.fields.TextField')(max_length=2000))

        # Changing field 'Profile.signature'
        db.alter_column('djangobb_forum_profile', 'signature', self.gf('django.db.models.fields.TextField')(max_length=2000))

    def backwards(self, orm):
        # Deleting field 'Forum.moderator_only'
        db.delete_column('djangobb_forum_forum', 'moderator_only')


        # Changing field 'Profile.signature_html'
        db.alter_column('djangobb_forum_profile', 'signature_html', self.gf('django.db.models.fields.TextField')(max_length=1024))

        # Changing field 'Profile.signature'
        db.alter_column('djangobb_forum_profile', 'signature', self.gf('django.db.models.fields.TextField')(max_length=1024))
